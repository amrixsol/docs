...
You can now view your complete transaction history from the History page. See all your deposits, withdrawals, and bill payments in one place with detailed information including status, timestamps, and blockchain explorer links. Filter by transaction type to quickly find what you're looking for.
